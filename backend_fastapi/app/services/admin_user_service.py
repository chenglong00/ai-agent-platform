"""Admin user management: list, get, create, update, delete, approve, reject."""
...
class AdminUserService:
    """User management for admins. Pass session per call."""
    ...
    async def update_user(
        ...
        *,
        ...
        """Update user by id. Only provided fields are updated. Returns updated user or None if not found. Raises ConflictError if email is taken by another user."""
        user = await session.get(User, user_id)
        if not user:
            return None
